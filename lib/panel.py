...
class Panel:
    ...
    def __init__(self, xywh: typing.Tuple[int, int, int, int] = None, polygon=None):
    ...
    def split(self):
        if self.polygon is None:
            raise Exception(
                "Fatal error, trying to split a Panel with no polygon (not the result of opencv.findContours)"
            )
