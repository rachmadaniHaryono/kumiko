...
""".format(
    ...
    def side_by_side_panels(img, jsons, v1, v2, images_dir, known_panels):
        html = '<h2>{0}</h2><div class="sidebyside"><div class="version">{1}</div><div class="version">{2}</div></div><div class="sidebyside">'.format(
            img, v1, v2
        )
    ...
    def reader(js, images_dir, debug):
        ...
        return """
                        ...
                        """.format(
            json=js, images_dir=images_dir, debug=debug
        )
